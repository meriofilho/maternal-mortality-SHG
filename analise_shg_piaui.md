...
- [20. Figuras finais para o artigo (limite de 5
  elementos)](#20-figuras-finais-para-o-artigo-limite-de-5-elementos)
  - [Figura 1 — Distribuição por tipo de síndrome
    hipertensiva](#figura-1--distribuição-por-tipo-de-síndrome-hipertensiva)
  - [Figura 2 — Perfil epidemiológico (painel
    A·B·C·D)](#figura-2--perfil-epidemiológico-painel-abcd)
...
- *Figura 2 — Perfil epidemiológico, painel A·B·C·D (objetivo específico
  1)*
...
![](analise_shg_piaui_files/figure-gfm/figura1-final-1.png)<!-- -->
...
![](analise_shg_piaui_files/figure-gfm/figura2-final-1.png)<!-- -->
...
![](analise_shg_piaui_files/figure-gfm/figura3-final-1.png)<!-- -->
...
![](analise_shg_piaui_files/figure-gfm/figura4-final-1.png)<!-- -->
